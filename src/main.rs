...
fn main() {
    App::new()
        ...
        .insert_resource(debug_colliders::DebugColliders(false))
        ...
        .add_systems(
            ...
            (
                ...
                ui::update_hud,
                debug_axes::draw_global_axes,
                debug_axes::draw_local_axes,
                debug_colliders::toggle_debug_colliders,
                debug_colliders::draw_colliders,
